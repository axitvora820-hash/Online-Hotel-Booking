                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header" style="background-color:lightgoldenrodyellow;">
                                    <h3 class="card-title" style="color: darkblue;"><b>HOTEL BOOKING DETAILS</b></h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                ?>
                                            <tr>
                                                <form id="form-<?php echo $reservation_id; ?>" action="room_process.php"
                                                    method="post">
                                                    <td><?php echo $num; ?></td>
                                                    ...
                                                    <td><?php echo htmlspecialchars($row['number_of_room']); ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="submit" name="confirm" class='btn btn-success'><i class="fas fa-check"></i></button>

                                                        <a href="roombooking_edit.php?id=<?php echo $reservation_id; ?>"><button
                                                                type="button" class="btn btn-primary"><i class="fas fa-user-edit"></i></button></a>

                                                        <a href="roombooking_delete.php?id=<?php echo $reservation_id; ?>"><button
                                                                type="button" class='btn btn-danger'><i class="fas fa-user-minus"></i></button></a>
