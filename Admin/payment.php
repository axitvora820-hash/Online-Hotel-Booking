...
<body class="hold-transition sidebar-mini layout-fixed">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="action">
                                                    ...
                                                    <a class="m-1" href="invoiceprint.php?id=<?php echo $res['id']; ?>" target="_top">
                                                        <button class="btn btn-primary"><i class="fas fa-print"></i></button>
                                                    </a>
                                                    <a class="m-1" href="payment_delete.php?id=<?php echo $res['id']; ?>">
    ...
    document.querySelector('.btn-primary').addEventListener('click', function(event) {
        ...
        var url = this.parentNode.getAttribute('href'); // Get the URL from the parent anchor tag
        window.open(url, '_blank'); // Open the invoice in a new window/tab
    });
    </script>
</body>
